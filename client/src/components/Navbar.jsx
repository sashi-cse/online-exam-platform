...
import { GraduationCap, BookOpen, ShieldCheck, LogOut, User as UserIcon, BarChart3 } from 'lucide-react';
            ...
            <>
              <Link
                ...
                className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-1.5 ${
                  location.pathname === '/admin' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800'
                }`}
              >
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2 bg-slate-800/80 px-3 py-1.5 rounded-lg border border-slate-700/50">
            ...
            <div className="text-left">
              ...
              <span className={`text-[10px] font-bold uppercase tracking-wider ${isAdmin ? 'text-amber-400' : 'text-blue-400'}`}>
